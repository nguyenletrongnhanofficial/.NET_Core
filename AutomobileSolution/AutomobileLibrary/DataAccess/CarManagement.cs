...
namespace AutomobileLibrary.DataAccess
{
    public class CarManagement
    {
        ...
        public IEnumerable<Car> GetCarList()
        {
            ...
            try
            {
                var myStoskDB = new MyStockContext();
                cars = myStoskDB.Cars.ToList();
            }
            catch (Exception ex)
            {
        ...
        public void Update (Car car)
        {
            try
            {
                ...
                {
                    throw new Exception("The car dose not already exist!");
                }
            }
            catch (Exception ex)
            {
        ...
        public void Remove (Car car)
        {
            try
            {
                ...
                {
                    throw new Exception("The car dose not already axist!");
                }
            }
            catch (Exception ex)
            {
